  ...
  if (interaction.isButton() && interaction.customId.startsWith('task_done_')) {
    ...
    if (db.completeTask(taskId)) {
      ...
      await interaction.reply({
        content: `✅ تم إنجاز مهمة <@${task.userId}> بنجاح بواسطة الإدارة العليا.`,
      });
...
client.once(Events.ClientReady, c => console.log(`✅ ${c.user.tag} شغال!`));

// التوكن يجي من ملف .env (متغير DISCORD_TOKEN)
